...
if((isset($_GET['qpname'])) && (!empty($_GET['qpname']))){
  $qpname = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['qpname']))));
}else{
  $qpname="";
}
if((isset($_GET['qpid'])) && (!empty($_GET['qpid']))){
  $qpid = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['qpid']))));
}else{
  $qpid="";
}
if((isset($_GET['posmarks'])) && (!empty($_GET['posmarks']))){
  $posmarks = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['posmarks']))));
}else{
  $posmarks="";
}
if((isset($_GET['negmarks'])) && (!empty($_GET['negmarks']))){
  $negmarks = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['negmarks']))));
}else{
  $negmarks="";
}
if((isset($_GET['partno'])) && (!empty($_GET['partno']))){
  $partno = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['partno']))));
}else{
  $partno="";
}
...
if((isset($_GET['qlevel'])) && (!empty($_GET['qlevel']))){
  $qlevel = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['qlevel']))));
}else{
  $qlevel="";
}

$settingssql = "select * from questionpaper where name='$qpname'";
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <?php 
                  $sql2 ="select * from questionentry where qpname='$qpname'";
                 ...
                 ?>
                  <div style="text-align:right;"><a style="float:left;" href="questionentryedit.php?id=<?php echo $previousqid; ?>" class="btn btn-primary">Previous</a><a href="questionentryforexam.php?qpid=<?php echo $qpid; ?>" class="btn btn-info">Que. List</a></div>
                  <hr>     
                </div>
              <div class="card-body">
                <?php 
                ...
                <form action="questionentryaddnewsubmit.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
                                      ...
                                      <select name="name" class="form-control" required="true">
                                        <?php 
                                        if($qpname!=''){
                                  ...
                                  <div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
                                    <input type="button" value="Get Parts" onclick="getname()" class="btn btn-success" style="margin-top:2em" required="true"> 
                                  </div>
                                  <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                                      <label for="part">Part</label>
                                      <select name="part" class="form-control" id="part" autofocus="true" required="true">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        ...
                                        <input type="text" value="<?php if($posmarks!=''){echo $posmarks;} ?>" class="form-control" id="positivemarks" name="positivemarks" required="true">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        <label for="negativemarks">Negative Marks</label>
                                        <input type="text" value="<?php if($negmarks!=''){echo $negmarks;} ?>" class="form-control" id="negativemarks" name="negativemarks" required="true">
                                    </div>
                                  </div>
                                  <br>
                              </div>
