				 								...
				 								<div class="col-lg-12">
				 									<div class="card">
						 								<div class="card-body">
			                                                ...
			                                                if($row1['imgid']!=""){?>
			                                                  <img alt="Question" src="../uploads/questions/<?php echo md5($row1['imgid']); ?>.jpg" class="img-responsive"><br>
			                                                  <?php 
			                                                }
		                                                    ?>
						 								</div>
						 									...
						 									<div class="card">
								 								<div class="card-body">
						                                              ...
						                                              if($row1['option1']!= "" && $row1['opt1img']!= ""){
		                                                                  ...
		                                                                  ?>
		                                                                  <br>
		                                                                  <img alt="Question" src="../uploads/questions/options/<?php echo md5($row1['opt1img']); ?>.jpg" class="img-responsive"><br>
		                                                                  <?php
		                                                              }elseif($row1['option1']!= ""){
		                                                                if($srnotype=="alphabets"){
																			echo "<br>(A) ";
						 									...
						 									<div class="card">
								 								<div class="card-body">
						                                              ...
						                                              if($row1['option2']!= "" && $row1['opt2img']!= ""){
		                                                                  ...
		                                                                  ?>
		                                                                  <br>
		                                                                  <img alt="Question" src="../uploads/questions/options/<?php echo md5($row1['opt2img']); ?>.jpg" class="img-responsive"><br>
		                                                                  <?php
		                                                              }elseif($row1['option2']!= ""){
		                                                                  if($srnotype=="alphabets"){
																			echo "<br>(B) ";
						 									...
						 									<div class="card">
								 								<div class="card-body">
						                                              ...
						                                              if($row1['option3']!= "" && $row1['opt3img']!= ""){
		                                                                  ...
		                                                                  ?>
		                                                                  <br>
		                                                                  <img alt="Question" src="../uploads/questions/options/<?php echo md5($row1['opt3img']); ?>.jpg" class="img-responsive"><br>
		                                                                  <?php
		                                                              }elseif($row1['option3']!= ""){
		                                                                  if($srnotype=="alphabets"){
																			echo "<br>(C) ";
						 									...
						 									<div class="card">
								 								<div class="card-body">
						                                              ...
						                                              if($row1['option4']!= "" && $row1['opt4img']!= ""){
		                                                                  ...
		                                                                  ?>
		                                                                  <br>
		                                                                  <img alt="Question" src="../uploads/questions/options/<?php echo md5($row1['opt4img']); ?>.jpg" class="img-responsive"><br>
		                                                                  <?php
		                                                              }elseif($row1['option4']!= ""){
		                                                                   if($srnotype=="alphabets"){
																			echo "<br>(D) ";
				 									...
				 									<div class="card">
						 								<div class="card-body">
						 									  ...
						 									  if($row1['solutionimg']!=""){
						 									  	...
						 									  	echo '<img src="../uploads/answers/'.md5($solutionimg).'.jpg" class="img-responsive">';
						 									  }
				                                              ?>
						 								</div>
						 							</div>
