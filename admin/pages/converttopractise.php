...
$qpid = htmlspecialchars(stripslashes(trim(mysqli_real_escape_string($conn,$_GET['qpid']))));
  ...
  $sql = "UPDATE questionpaper set examtype='practisetest' where qpid='$qpid'";
  $conn->query($sql);
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#mytitle").text("Convert To Practise Test");
});
</script>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12 col-xs-12 col-lg-12">
            <div class="card">
              <div class="card-body">
                <h3>Converted To Practise Test: <span style="color:green">Done!</span></h3>
              </div>
            </div>
          </div>
        </div>
