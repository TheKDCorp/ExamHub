...
$sql ="INSERT INTO examattempted(attid,examid,examname,studentid,examtype)VALUES(DEFAULT,'$examid','$examname','$cid','$examtype')";
$conn->query($sql);
...
<head>
    ...
    <title>Macro Vision Academy | National Testing Agency</title>
...
<body oncontextmenu="return false;" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
                        ...
                        <div class="navbar-collapse">
                            <ul class="nav navbar-nav pull-right exam-paper ">
                                <li class="user-profile">
                                    <table>
                                        <tr>
                                            <td style="padding: 2px; border: 2px solid #666"><img style="padding:0px;margin:0px;width:60px;height:70px;" src="../admin/profile/<?php echo md5($rowstudent['imgsrc']).'jt'. md5($row['imgsrc']).'.jpg'; ?>"></td>
                                            <td>
                                                <table>
                                                    <tr>
    ...
    <div id="allpagethird" style="display:none;">
        ...
        <div id="content">
          <!-- <div class="container"> -->
              <section>
                  <div class="row">
                      <div class="col-lg-12 exam-confirm">
    ...
    <div id="allpagefourth" style="display:none;">
      <form action="exam_submit.php" onSubmit="return checkform();"  id="myexamform" method="post">
        ...
        <div id="all">
                            ...
                            <div class="navbar-collapse">
                                <ul class="nav navbar-nav pull-right">
                                    <li class="user-profile">
                                        <table>
                                            <tr>
                                                <td style="padding: 2px; border: 2px solid #666"><img style="padding:0px;margin:0px;width:60px;height:70px;" src="../admin/profile/<?php echo $rowstudent['imgsrc'].'jt'. $rowstudent['imgsrc'].'.jpg'; ?>"></td>
                                                <td>
                                                    <table>
                                                        <tr>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 text-right">
                      <div style="padding: 15px 0 0 0">
                          <!-- <a class="btn btn-primary pull-left full-width" target="_blank" href="https://www.nta.ac.in/assets/quiz/pdf/JEE-Main-2018.pdf"><i class="fa fa-download"></i> Download Question</a> -->
                      </div>
                  </div>
                  <div class="clear-xs"></div>
                <!-- </div> -->
          ...
          <div id="content">
              <div class="container" style="margin-left:2%;margin-right:2%;width:100%;">
                  <div class="row exam-paper">
                      <div class="col-lg-9" id="quest" style="padding:0;height:80vh;">
                          <table style="width:100%">
                              <tr>
                                  <td>
                                      <div class="panel panel-default" style="padding:0px;">
                                          <div class="panel-body mb0" style="padding:0px;">
                                              ...
                                              if($getanswer == "true"){
                                                ...
                                                while($row1=$result1->fetch_assoc()){
                                                  ...
                                                  if($result2->num_rows > 0){
                                                    ...
                                                    ?>
                                                      <div style="<?php if($no != "1"){echo "display:none;";}?>padding-top:0px;" class="tab-content div-question mb0" id="page<?php if($no<=9){echo "0";}echo $no; ?>">
                                                          ...
                                                          <div class="question-height" style="height:52vh;">
                                                                            ...
                                                                            if($row1['choosedoption']==""){
                                                                             ...
                                                                             ?>
                                                                              <tr>
                                                                                  ...
                                                                                  <td> <input type="radio" value="3" name="radiospage<?php if($no<=9){echo "0";}echo $no; ?>" id="rOption<?php echo $no; ?>_1" <?php if($row1['choosedoption']=="2"){echo 'checked';} ?>> C ) </td>
                                                ...
                                                if($result1->num_rows > 0){
                                                  ...
                                                  if($result2->num_rows > 0){
                                                    ...
                                                    ?>
                                                      <div style="<?php if($no != "1"){echo "display:none;";} ?>" class="tab-content div-question mb0" id="page<?php if($no<=9){echo "0";}echo $no; ?>">
                                                          <input type="hidden" value="1" class="hdfQuestionID">
                                                          <input type="hidden" value="1" class="hdfPaperSetID">
                                                          <input type="hidden" value="4" class="hdfCurrectAns">
                                      ...
                                      <div class="panel-footer" style="margin-top:0px;">
                                          <div class="row">
                                              <div class="col-lg-12"> <button class="btn btn-success btn-submit-all-answers pull-right">Submit</button>&nbsp;&nbsp; <a href="javascript:void(0);" class="btn btn-default pull-left" id="btnPrevQue"> << Back </a>&nbsp;&nbsp; <a href="javascript:void(0);" class="btn btn-default pull-left" id="btnNextQue">Next >></a>&nbsp;&nbsp; </div>
                                          </div>
                                      </div>
                                  </td>
                                  <td>
                      ...
                      <div class="col-lg-3" id="pallette" style="height:75vh;overflow:hidden;">
                          <div class="panel panel-default " style="height:55vh;overflow-y:scroll;">
                              <div class="panel-body" >
                  ...
                  <div class="row">
                      <div class="col-lg-12 exam-summery" style="display:none;">
                          <div class="panel panel-default">
                              <div class="panel-body">
                      ...
                      <div class="col-lg-12 exam-confirm" style="display:none;">
                          <div class="panel panel-default">
                              <div class="panel-body">
                                  <div class="col-lg-12 text-center">
                      ...
                      <div class="col-lg-12 exam-result" style="display:none;">
                          <div class="panel panel-default">
                              <div class="panel-body">
                                  <div class="col-lg-12 text-center">
                                      <h3>
    ...
    $('.full_screen').click(function () {
        $('#quest').removeClass('col-lg-10');
        $('#quest').addClass('col-lg-12');
    ...
    $('.collapse_screen').click(function () {
        $('#quest').removeClass('col-lg-12');
        $('#quest').addClass('col-lg-10');
